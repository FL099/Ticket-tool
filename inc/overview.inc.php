    ...
    <div class="container" id="overview">
		<div class="row">
			<div class="card col-5 bg-dark" >
				<img src=<?php echo"$graphen[0]"?> class="card-img-top" alt="..." style="height:250px;">
	    			<a href="#">
		          		<div class="card-body">
			...
			<div class="card col-5 bg-dark">
				<img src=<?php echo"$graphen[1]"?> class="card-img-top" alt="..." style="height:250px;">
    			<a href="#">
		  		    <div class="card-body">
		...
		<div class="row">
			<div class="card col-5 bg-dark">
				<img src=<?php echo"$graphen[2]"?> class="card-img-top" alt="..." style="height:250px;">
				<a href="#">
    		  		<div class="card-body">
	    	    		<h5 class="card-title text-white">Card title</h5>
			  		</div>
    		...
    		<div class="card col-5 bg-dark" >
				<img src=<?php echo"$graphen[3]"?> class="card-img-top" alt="..." style="height:250px;">
					<a href="#">
				  		<div class="card-body">
				    		<h5 class="card-title text-white">Erledigte Projekte diese Woche</h5>
				  		</div>
